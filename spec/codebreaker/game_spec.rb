...
RSpec.describe Game do
  ...
  context '.submit' do
    ...
    it 'should  be increment by 1' do
      ...
      expect{@game.submit}.to change{@game.choice_did}.by(1)
    end

    it 'should not be increment by 1' do
      @game.stub(:gets).and_return('Exit')
      expect{@game.submit}.to change{@game.choice_did}.by(0)
    end
  end
end
